...
final allProductQueryProvider = AutoDisposeNotifierProvider.family<
    AllProductQueryNotifier, QueryMap, ProductsFilter>(
  AllProductQueryNotifier.new,
);

class AllProductQueryNotifier
    extends AutoDisposeFamilyNotifier<QueryMap, ProductsFilter> {
  @override
  QueryMap build(arg) {
