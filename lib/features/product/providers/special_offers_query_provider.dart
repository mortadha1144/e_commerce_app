...
final specialOffersQueryProvider = AutoDisposeNotifierProvider.family<
    SpecialOffersQueryNotifier, Query<ProductModel>, ProductsFilter>(
  SpecialOffersQueryNotifier.new,
);

class SpecialOffersQueryNotifier
    extends AutoDisposeFamilyNotifier<Query<ProductModel>, ProductsFilter> {
  @override
  ...
  void search(String query, ProductsFilter filter) {
    state = ref
        ...
        .searchSpecialOffersProducts(query, filter);
  }
