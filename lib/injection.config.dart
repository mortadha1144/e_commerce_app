...
import 'package:e_commerce_app/core/utils/services/app_module.dart' as _i8;
import 'package:e_commerce_app/core/utils/services/firebase_servic.dart' as _i5;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i6.ProductRepo>(() => _i6.ProductRepo(
          gh<_i3.FirebaseAuth>(),
          gh<_i4.FirebaseFirestore>(),
        ));
    gh.factory<_i7.ProductCubit>(() => _i7.ProductCubit(gh<_i6.ProductRepo>()));
    return this;
  }
}
